...
#define REGLA 122 // [4, 32, 90, 94, 122, 150, 182]
...
int main(int argc, char** argv)
{
    ...
    double R, numRand, a, b, r, rat2;
    int ACE[ T+1 ][ N+2 ], ACE2[ T+1 ][ N+2 ];
    FILE *fileHamming;
    
    fileHamming = fopen("hamming_122.dat","w+");
...
//            printf("%d\n", H);
    ...
    guardaPGMi("ACE_R122_Randomseed.pgm", N+2, T+1, (int*)ACE, 1, 0);
    guardaPGMi("ACE2_R122_Randomseed.pgm", N+2, T+1, (int*)ACE2, 1, 0);

    fclose(fileHamming);
    
    
    logreg("hamming_122.dat", &a, &b, &rat2);
    r = sqrt(rat2);
    printf("Haming coefficient (a) = %lf\n", a);
    printf("b = %lf, r = %lf\n", b, r);
